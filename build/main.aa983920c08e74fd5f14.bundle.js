...
/* harmony import */ var _recoil_atoms_movieAtom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @recoil/atoms/movieAtom */ "./src/recoil/atoms/movieAtom.ts");
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-browser/v4.js");
/* harmony import */ var _hooks_useInfinityScroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @hooks/useInfinityScroll */ "./src/hooks/useInfinityScroll.ts");
...
const Content = () => {
  const movies = (0,recoil__WEBPACK_IMPORTED_MODULE_1__.useRecoilValue)(_recoil_atoms_movieAtom__WEBPACK_IMPORTED_MODULE_3__.movieState);
  const [page, setPage] = (0,recoil__WEBPACK_IMPORTED_MODULE_1__.useRecoilState)(_recoil_atoms_movieAtom__WEBPACK_IMPORTED_MODULE_3__.moviePage);
  const [curMovies, setMovie] = (0,recoil__WEBPACK_IMPORTED_MODULE_1__.useRecoilState)(_recoil_selectors_movieSelector__WEBPACK_IMPORTED_MODULE_2__.getMoviesQuery);
  ...
  const setTarget = (0,_hooks_useInfinityScroll__WEBPACK_IMPORTED_MODULE_4__["default"])({
    onIntersect,
    threshold: 0
  });
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("article", {
    className: "h-[200px] bg bg-red-100 overflow-y-auto"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    onClick: () => {
      setPage(page + 1);
      setMovie(curMovies);
    }
  }, "click"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, movies.map((v, i) => {
    if (i === 10 * (page - 1)) {
...
const Switch = () => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("label", {
    className: (0,_utils_styleUtil__WEBPACK_IMPORTED_MODULE_1__.joinClass)('relative block w-16 px-1 py-1 bg-gray-100 font-medium text-xs rounded-full shadow-md transition-colors duration-100', !isTvOn ? 'bg-gray-700' : 'bg-blue-500')
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
...
/* harmony import */ var _Content__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Content */ "./src/pages/Home/Content.tsx");
...
const Home = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_MainLayout__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    classes: "sm:w-96"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Filter__WEBPACK_IMPORTED_MODULE_3__["default"], null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_Content__WEBPACK_IMPORTED_MODULE_4__["default"], null));
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "moviePage": () => (/* binding */ moviePage),
/* harmony export */   "movieState": () => (/* binding */ movieState)
/* harmony export */ });
/* harmony import */ var recoil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! recoil */ "./node_modules/recoil/es/recoil.js");

const moviePage = (0,recoil__WEBPACK_IMPORTED_MODULE_0__.atom)({
  key: 'moviePage',
  default: 1
});
const movieState = (0,recoil__WEBPACK_IMPORTED_MODULE_0__.atom)({
  key: 'movieState',
  default: []
});
...
const getMoviesQuery = (0,recoil__WEBPACK_IMPORTED_MODULE_2__.selector)({
  key: 'getMoviesQuery',
  get: async ({
    get
  }) => {
    try {
      const {
        ...
        params: {
          page: get(_atoms_movieAtom__WEBPACK_IMPORTED_MODULE_0__.moviePage),
  ...
  set: ({
    ...
    const preMovies = get(_atoms_movieAtom__WEBPACK_IMPORTED_MODULE_0__.movieState);

    if (!(curMovies instanceof recoil__WEBPACK_IMPORTED_MODULE_2__.DefaultValue)) {
      set(_atoms_movieAtom__WEBPACK_IMPORTED_MODULE_0__.movieState, [...preMovies, ...curMovies]);
    }
  }
});
const test = (0,recoil__WEBPACK_IMPORTED_MODULE_2__.atom)({
  key: 'test',
  default: 1
});
const testSelector = (0,recoil__WEBPACK_IMPORTED_MODULE_2__.selector)({
  key: 'testSelector',
  get: async ({
    get
  }) => {
...
/******/ })()
;
//# sourceMappingURL=main.aa983920c08e74fd5f14.bundle.js.map